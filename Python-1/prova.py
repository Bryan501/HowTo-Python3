...
def inicio():
    while True:
        try:
            ...
            # Validar si el input es numérico y convertirlo a entero
            if not decision.isdigit():
                raise ValueError("ERROR: Por favor, ingrese un número válido (1, 2 o 3).")
            ...
            # Captura el error si no es un número válido
            print(e)
